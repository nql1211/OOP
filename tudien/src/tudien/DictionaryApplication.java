...
import static tudien.DictionaryApplication.t;
import static tudien.DictionaryApplication.t1;
...
class frameMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        translate.addActionListener(this::translateActionPerformed);

        pronounce.setBackground(new java.awt.Color(51, 102, 255));
        pronounce.setText("Phát âm");
        pronounce.addActionListener(this::pronounceActionPerformed);
...
//        jLabel1.setText("NGHĨA");
        ...
        suggestions.addListSelectionListener(this::suggestionsValueChanged);
    ...
    private void suggestionsValueChanged(javax.swing.event.ListSelectionEvent evt) {                                         
        // TODO add your handling code here:
        try {
            whereFillWord.setText(suggestions.getSelectedValue());
        } catch (Exception e) {
